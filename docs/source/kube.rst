Scaling [cybersecurityrtms-elastalink-3f10-ai] With Kubernetes
===========================
...
Based on your TML solution [cybersecurityrtms-elastalink-3f10-ai] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`cybersecurityrtms-elastalink-3f10-ai.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-cybersecurityrtms-elastalink-3f10-ai.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingresscybersecurityrtms-elastalink-3f10-ai.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f qdrant.yml -f privategpt.yml -f cybersecurityrtms-elastalink-3f10-ai.yml

cybersecurityrtms-elastalink-3f10-ai.yml
------------------------

.. important::
   Copy and Paste this YAML file: cybersecurityrtms-elastalink-3f10-ai.yml - and save it locally.
...
.. code-block:: YAML
   ...
   ################# cybersecurityrtms-elastalink-3f10-ai.yml
     ...
     kind: Deployment
     metadata:
       name: cybersecurityrtms-elastalink-3f10-ai
     spec:
       selector:
         matchLabels:
           app: cybersecurityrtms-elastalink-3f10-ai
       ...
       template:
         ...
         spec:
           containers:
           - name: cybersecurityrtms-elastalink-3f10-ai
             image: maadsdocker/cybersecurityrtms-elastalink-3f10-ai-amd64:latest
             volumeMounts:
             - name: dockerpath
             ...
             - name: TSS
               value: '0'
             - name: PROJECTNAME
               value: 'cybersecurityrtms-elastalink-3f10'                              
             - name: SOLUTIONNAME
               value: 'cybersecurityrtms-elastalink-3f10-ai'
             - name: SOLUTIONDAG
               value: 'solution_preprocessing_ai_dag-cybersecurityrtms-elastalink-3f10'
             - name: GITUSERNAME
               value: 'smaurice101'
             - name: GITREPOURL
   ...
   ---
     ...
     kind: Service
     metadata:
       name: cybersecurityrtms-elastalink-3f10-ai-visualization-service
       labels:
         app: cybersecurityrtms-elastalink-3f10-ai-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/cybersecurityrtms-elastalink-3f10-ai 6060:6060
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-cybersecurityrtms-elastalink-3f10-ai.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-cybersecurityrtms-elastalink-3f10-ai.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-cybersecurityrtms-elastalink-3f10-ai.yml
